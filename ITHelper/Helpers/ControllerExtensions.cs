...
namespace ITHelper.Helpers
{
    ...
    {
        // Taken from: https://stackoverflow.com/questions/40912375/return-view-as-string-in-net-core
        ...
        public static async Task<string> OriginalRenderViewAsync<TModel>(this Controller controller, string viewName, TModel model, bool partial = false)
        {
            if (string.IsNullOrEmpty(viewName))
            {
                viewName = controller.ControllerContext.ActionDescriptor.ActionName;
